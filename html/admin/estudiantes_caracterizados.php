...
$sql = "SELECT * FROM `sociodemografico`";
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 text-center p-4" style="padding-left: 5%; padding-right: 5%">
                <div class="card">
                    <div class="p-5">
                    <h1  style="color: #2c4a73; font-weight: bold">Estudiantes Caracterizados</h1>
                    <hr>
                    <table id="customers">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="detalle_socio.php?id=<?php echo $fila[0] ?>" class="btn btn-info"><i class='bx bxs-user-detail'></i></a></td>
                            </tr>
                            <?php 
                                }
                            ?>
